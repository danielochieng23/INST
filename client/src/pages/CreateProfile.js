...
const CreateProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('/api/profiles', formDataToSend, {
        headers: {
  ...
  return (
    <CreateContainer className="fade-in">
      <div className="container">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold mb-2">Create Your Educational Profile</h1>
          <p className="text-lg text-secondary">
            Showcase your educational journey, skills, and achievements
          </p>
        </div>
          ...
          <FormCard>
            ...
            <div className="form-group">
              ...
              <FileUpload onClick={() => document.getElementById('avatar').click()}>
                ...
                <p>{avatar ? avatar.name : 'Click to upload profile picture'}</p>
              </FileUpload>
            </div>
          </FormCard>
